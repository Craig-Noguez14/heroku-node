...
prototype.setIgnoreFriend = function(steamID, setIgnore, callback) {
    this._send(EMsg.ClientSetIgnoreFriend, new schema.MsgClientSetIgnoreFriend({
        mySteamId: this.steamID,
...
handlers[EMsg.ClientSetIgnoreFriendResponse] = function(data, callback) {
    callback(schema.MsgClientSetIgnoreFriendResponse.decode(data).result);
};
